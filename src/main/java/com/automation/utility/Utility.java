...
import java.util.Random;
    ...
    public class Utility extends ManageDriver {
         ...
         */
        public boolean verifyIfGetTextOfElementIsMatchedWithExpectedTextOfElement(WebElement element, String textToBeVerified) {
            String actualText = getTextFromElement(element);
            if (actualText.contains(textToBeVerified)) {
                return true;
            } else {
                return false;
            }
    ...
    public void verifyElements(String expectedMessage, By by, String displayMessage ){
      ...
      //  Assert.assertEquals(expectedErrorMessage, actualErrorMessage, "Error message not displayed");
       // Assert.assertEquals(displayMessage, expectedMessage, actualMessage);
        ...
        // wait for element with Fluent Wait
        public WebElement waitForElementWithFluentWait(final By by, WebDriver driver) {
            Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
...
*/
        ...
        public static void takeScreenShot() {
            ...
            TakesScreenshot screenshot = (TakesScre enshot) driver;
